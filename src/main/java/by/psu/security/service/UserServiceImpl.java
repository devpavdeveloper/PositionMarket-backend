...
import by.psu.repository.RoleRepository;
import by.psu.repository.TokenRepository;
...
public class UserServiceImpl implements UserService {
    ...
    public VerificationToken getVerificationToken(String token, String email) {
        ...
        if (!Objects.isNull(u)) {
            VerificationToken tokenObj = tokenRepository.findByUser(u);
            if (passwordEncoderBean.matches(token, tokenObj.getToken())) {
                return tokenObj;
            } else {
